			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red"> 順天建設永春段接待中心 </span> <br />
						<span class="left_content_desc_title">Client :</span> Sweeten <br />
						<span class="left_content_desc_title">Location :</span> Taichung City <br />
                        <span class="left_content_desc_title">Typology :</span> garden <br />
                        <span class="left_content_desc_title">Status :</span> 2021 <br />
						<span class="left_content_desc_title">Size  :</span> 5,000 M2 <br />
                        <br />
						
                        <span class="left_content_desc_title ch">業主 :</span> 順天建設 <br />
