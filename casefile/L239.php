			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red"> 大可山石│東煒建設 </span> <br />
						<span class="left_content_desc_title">Client :</span> Tung Wei Construction Co. Ltd. <br />
						...
						<span class="left_content_desc_title">Size  :</span> 600 M2 <br />
                        <br />
						
                        <span class="left_content_desc_title ch">業主 :</span> 東煒建設股份有限公司 <br />
						<span class="left_content_desc_title ch">類型 :</span> 集合住宅 <br />
                        <span class="left_content_desc_title ch">獎項 :</span>  <br />
                        <span class="left_content_desc_title ch"></span> 2020 IPA英國房地產亞太區大獎-亞太區大獎 <br />
                        <span class="left_content_desc_title ch" style="margin-left:32px;"></span> 最佳高樓層住宅開發台灣五星首獎 <br />
                        <span class="left_content_desc_title ch" style="margin-left:32px;"></span> International Property Awards <br />
                        <span class="left_content_desc_title ch"></span> 2020 New York Design Award Silver <br />
                    </p>
				</div>
				<div class="right_content">
                    <div><img src="../theme/images/L239/1.jpg" /></div>
                    <div><img src="../theme/images/L239/2.jpg" /></div>
                    <div><img src="../theme/images/L239/3.jpg" /></div>
                    <div><img src="../theme/images/L239/4.jpg" /></div>
				</div>
