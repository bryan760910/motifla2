			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red"> Into the arms of stillness│擁恆的彼端 </span> <br />
						<span class="left_content_desc_title">Client :</span> Taipei Fine Arts Museum <br />
						<span class="left_content_desc_title">Location :</span> THE 201 ART <br />
						...
						<span class="left_content_desc_title">Size  :</span> 300 M2 <br />
                        <br />
						
                        <span class="left_content_desc_title ch">業主 :</span> THE 201 ART 順天建築.文化.藝術中心 <br /> 清水建築工坊 <br />
